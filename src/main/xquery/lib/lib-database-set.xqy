...
declare function  inst-db-set:do-database-set-1($database-name, $set)
{
    ...
    let $config := 
        ...
        else if ("collection-lexicon"                           eq $name) then admin:database-set-collection-lexicon($config, $database-id, xs:boolean($value))
        else if ("directory-creation"                           eq $name) then admin:database-set-directory-creation($config, $database-id, xs:string($value))    
        else if ("element-value-positions"                      eq $name) then admin:database-set-element-value-positions($config, $database-id, xs:boolean($value))
        else if ("element-word-positions"                       eq $name) then admin:database-set-element-word-positions($config, $database-id, xs:boolean($value))
        else if ("enabled"                                      eq $name) then admin:database-set-enabled($config, $database-id, xs:boolean($value))
        else if ("expunge-locks"                                eq $name) then admin:database-set-expunge-locks($config, $database-id, xs:string($value))
        else if ("fast-case-sensitive-searches"                 eq $name) then admin:database-set-fast-case-sensitive-searches($config, $database-id, xs:boolean($value))
        else if ("fast-diacritic-sensitive-searches"            eq $name) then admin:database-set-fast-diacritic-sensitive-searches($config, $database-id, xs:boolean($value))
        else if ("fast-element-character-searches"              eq $name) then admin:database-set-fast-element-character-searches($config, $database-id, xs:boolean($value))
        else if ("fast-element-phrase-searches"                 eq $name) then admin:database-set-fast-element-phrase-searches($config, $database-id, xs:boolean($value))
        else if ("fast-element-trailing-wildcard-searches"      eq $name) then admin:database-set-fast-element-trailing-wildcard-searches($config, $database-id, xs:boolean($value))
        else if ("fast-element-word-searches"                   eq $name) then admin:database-set-fast-element-word-searches($config, $database-id, xs:boolean($value))
        else if ("fast-phrase-searches"                         eq $name) then admin:database-set-fast-phrase-searches($config, $database-id, xs:boolean($value))
        else if ("fast-reverse-searches"                        eq $name) then admin:database-set-fast-reverse-searches($config, $database-id, xs:boolean($value))
        ...
        else if ("inherit-collections"                          eq $name) then admin:database-set-inherit-collections($config, $database-id, xs:boolean($value))
...
declare function  inst-db-set:do-database-set-2($database-name, $set)
{
    ...
    let $config := 
        ...
        else if ("maintain-directory-last-modified"             eq $name) then admin:database-set-maintain-directory-last-modified($config, $database-id, xs:boolean($value))
        else if ("maintain-last-modified"                       eq $name) then admin:database-set-maintain-last-modified($config, $database-id, xs:boolean($value))
        ...
        else if ("name"                                         eq $name) then admin:database-set-name($config, $database-id, xs:boolean($value))
        else if ("one-character-searches"                       eq $name) then admin:database-set-one-character-searches($config, $database-id, xs:boolean($value))
        ...
        else if ("preallocate-journals"                         eq $name) then admin:database-set-preallocate-journals($config, $database-id, xs:boolean($value))
        else if ("preload-mapped-data"                          eq $name) then admin:database-set-preload-mapped-data($config, $database-id, xs:boolean($value))
        else if ("reindexer-enable"                             eq $name) then admin:database-set-reindexer-enable($config, $database-id, xs:boolean($value))
        ...
        else if ("tf-normalization"                             eq $name) then admin:database-set-tf-normalization($config, $database-id, xs:boolean($value))
        else if ("three-character-searches"                     eq $name) then admin:database-set-three-character-searches($config, $database-id, xs:boolean($value))
        else if ("three-character-word-positions"               eq $name) then admin:database-set-three-character-word-positions($config, $database-id, xs:boolean($value))
        else if ("trailing-wildcard-searches"                   eq $name) then admin:database-set-trailing-wildcard-searches($config, $database-id, xs:boolean($value))
        else if ("trailing-wildcard-word-positions"             eq $name) then admin:database-set-trailing-wildcard-word-positions($config, $database-id, xs:boolean($value))
        else if ("two-character-searches"                       eq $name) then admin:database-set-two-character-searches($config, $database-id, xs:boolean($value))
        else if ("uri-lexicon"                                  eq $name) then admin:database-set-uri-lexicon($config, $database-id, xs:boolean($value))
        else if ("word-positions"                               eq $name) then admin:database-set-word-positions($config, $database-id, xs:boolean($value))
        else if ("word-query-fast-case-sensitive-searches"      eq $name) then admin:database-set-word-query-fast-case-sensitive-searches($config, $database-id, xs:boolean($value))
        else if ("word-query-fast-diacritic-sensitive-searches" eq $name) then admin:database-set-word-query-fast-diacritic-sensitive-searches($config, $database-id, xs:boolean($value))
        else if ("word-query-fast-phrase-searches"              eq $name) then admin:database-set-word-query-fast-phrase-searches($config, $database-id, xs:boolean($value))
        else if ("word-query-include-document-root"             eq $name) then admin:database-set-word-query-include-document-root($config, $database-id, xs:boolean($value))
        else if ("word-query-one-character-searches"            eq $name) then admin:database-set-word-query-one-character-searches($config, $database-id, xs:boolean($value))
        else if ("word-query-stemmed-searches"                  eq $name) then admin:database-set-word-query-stemmed-searches($config, $database-id, xs:boolean($value))
        else if ("word-query-three-character-searches"          eq $name) then admin:database-set-word-query-three-character-searches($config, $database-id, xs:boolean($value))
        else if ("word-query-three-character-word-positions"    eq $name) then admin:database-set-word-query-three-character-word-positions($config, $database-id, xs:boolean($value))
        else if ("word-query-trailing-wildcard-searches"        eq $name) then admin:database-set-word-query-trailing-wildcard-searches($config, $database-id, xs:boolean($value))
        else if ("word-query-trailing-wildcard-word-positions"  eq $name) then admin:database-set-word-query-trailing-wildcard-word-positions($config, $database-id, xs:boolean($value))
